<template>
  <div class="notification-bubble-item">
    <div class="msg-card" v-dompurify-html="item.message.replace(/\n+/g, '<br/>')"></div>
  </div>
</template>
